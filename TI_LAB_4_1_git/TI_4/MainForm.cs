...
public partial class MainForm : Form
{
    ...
    {
        // Убрана проверка на длину текста, так как теперь можно работать с пустыми файлами
        ...
        if (RadioButtonCreate.Checked)
        {
            ...
            EdsValue = RSA.QuickPowerMod(HashFunction, BigIntegerE, BigIntegerR);
        ...
        if (RadioButtonCheck.Checked)
        {
            ...
            HashFunction = EDS.HashFunction(OpenedFileBytes, BigIntegerR);
            TextBoxHash.Text = HashFunction.ToString();
            var temp = RSA.QuickPowerMod(EdsValue, BigIntegerD, BigIntegerR);
